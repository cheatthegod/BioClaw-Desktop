...
const dict: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'hub.section.history': '对话历史',
    'hub.history.pickThread': '选择左侧一个对话查看历史消息',
    'hub.history.assistant': '助手',
    'hub.history.continue': '在聊天中继续',
  ...
  en: {
    ...
    'hub.section.history': 'Chat history',
    'hub.history.pickThread': 'Select a conversation on the left to view its messages',
    'hub.history.assistant': 'Assistant',
    'hub.history.continue': 'Continue in chat',
